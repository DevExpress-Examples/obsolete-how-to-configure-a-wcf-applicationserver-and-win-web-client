    ...
    static class Program {
        ...
        static void Main() {
            try {
                ...
                IDataLayer dataLayer = new SimpleDataLayer(XpoTypesInfoHelper.GetXpoTypeInfoSource().XPDictionary, DevExpress.Xpo.XpoDefault.GetConnectionProvider(connectionString, AutoCreateOption.DatabaseAndSchema));
