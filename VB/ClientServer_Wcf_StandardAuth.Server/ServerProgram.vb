    ...
    Friend NotInheritable Class Program
        ...
        Shared Sub Main()
            Try
                ...
                AddHandler serverApplication.CreateCustomObjectSpaceProvider, Sub(sender As Object, e As CreateCustomObjectSpaceProviderEventArgs) e.ObjectSpaceProvider = New XPObjectSpaceProvider(connectionString, Nothing)
                ...
                Dim dataLayer As IDataLayer = New SimpleDataLayer(XpoTypesInfoHelper.GetXpoTypeInfoSource().XPDictionary, DevExpress.Xpo.XpoDefault.GetConnectionProvider(connectionString, AutoCreateOption.DatabaseAndSchema))
